    ...
    if (inputTriangles != String.null) {
        ...
        for (var whichSet = 0; whichSet < inputTriangles.length; whichSet++) {
            ...
            for (whichSetVert = 0; whichSetVert < inputTriangles[whichSet].vertices.length; whichSetVert++) {
                ...
                diffuseToAdd.push(inputTriangles[whichSet].material.diffuse[0], inputTriangles[whichSet].material.diffuse[1], inputTriangles[whichSet].material.diffuse[2]);
            ...
            for (whichSetTri = 0; whichSetTri < inputTriangles[whichSet].triangles.length; whichSetTri++) {
                ...
                // set up the triangle diffuse color array
        ...
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(diffuseToAdd), gl.STATIC_DRAW);
    ...
    try {
        ...
        if (!gl.getShaderParameter(fShader, gl.COMPILE_STATUS)) { // bad frag shader compile
            ...
            if (!gl.getProgramParameter(shaderProgram, gl.LINK_STATUS)) { // bad program link
                ...
                colorPositionAttrib = // get pointer to color shader input
...
function renderTriangles() {
     ...
     *
     * For this scene, we’re saying that our (vertical) field of view is 45°,
     * we’re telling it about the width-to-height ratio of our canvas, and saying that
     * we don’t want to see things that are closer than 0.5 units to our viewpoint,
     * and that we don’t want to see things that are further away than 5 units.
     */

    mat4.perspective(pMatrix, Math.PI / 2, gl.viewportWidth / gl.viewportHeight, 0.5, 5);
